...
:::note
This guide was updated for `ACS v4.22` and tested on x86_64 and ARM64 hosts such
...
<img src={rpiImg.src} width={rpiImg.width} height={rpiImg.height} alt="CloudStack and RPi Board" />

This guide covers the installation and build of Apache CloudStack IaaS cloud on
Ubuntu using KVM, for both x86_64 and ARM64 architectures. If you're new to
Apache CloudStack, here a video for you:
[CloudStack 101: The Best Way to Build Your Private Cloud](https://www.youtube.com/watch?v=pASzZR57V_8)

<iframe width="640" height="480" src="https://www.youtube.com/embed/pASzZR57V_8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
